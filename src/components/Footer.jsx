      ...
      <Grid2 container size={12}>
        ...
        >
          <Grid2 item sx={{ width: "220px" }}>
            <Typography variant="h5" className="pri">
              e-Shop
            </Typography>
            <br />
            <Typography variant="subtitle2" sx={{ padding: "4px 0" }}>
              <Link href="#" className="conte">
                Armar tu Pack LG
              </Link>
            </Typography>
            <Typography variant="subtitle2" sx={{ padding: "4px 0" }}>
        ...
        <Grid2 container size={12} className="fg">
          <Grid2 container size={8} className="uno">
            <Button
              className="it"
              href="/pdf/final.pdf"
          ...
          <Grid2 item size={4} className="dos">
            <Link href="https://ethics.lg.co.kr/main/en.do" className="it kl">
        ...
        {/* me falta la responsibo de esta ultima parte */}
      </Grid2>
    </div>
  );
}
